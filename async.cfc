...
<cffunction name="createWorkUnit" access="public">
...
<cffunction name="executeWorkUnit" access="public">
...
<cffunction name="executeWorkUnitGroup" access="public">
...
<cffunction name="hasWork" access="public">
	<cfscript>
	if(variables.configStruct.enableGlobalThreadLimit){  
